        ...
        <div style={{ maxWidth: 360, margin: '80px auto', padding: 24, border: '1px solid #ddd', borderRadius: 8 }}>
            ...
            <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: 12 }}>
                    <label htmlFor="username">Ten dang nhap</label><br />
                    <input id="username" value={username} onChange={(event) => setUsername(event.target.value)} style={{ width: '100%' }} />
                </div>
                <div style={{ marginBottom: 12 }}>
                    <label htmlFor="password">Mat khau</label><br />
                    <input id="password" type="password" value={password} onChange={(event) => setPassword(event.target.value)} style={{ width: '100%' }} />
                </div>
